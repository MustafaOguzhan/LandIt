...
- Monetization: **7-day free trial, card required to start**, then a
  **paid subscription — $18/month or $89/year** (owner's decision, revised
  down from an initial $24/$99, then back up from $13/month once the AI
  content-writing feature — see status table below — narrowed the gap with
  Rezi.ai (~$29/mo); yearly stayed at $89, still a real discount vs. paying
  monthly all year (~59% at the current monthly price, not the ~43% quoted
  when this was $13/month — the percentage moves with the monthly price,
  yearly didn't change)). No lifetime/one-time-payment tier — explicitly
  ruled out by the owner due to the unbounded long-term support liability
