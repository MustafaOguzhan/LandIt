...
### Setting up Stripe (the $9/mo or $49/yr subscription)

1. Create an account at [stripe.com](https://stripe.com).
2. Go to **Product catalog → Add product**. Name it (e.g. "LandIt Pro"),
   add a price: **Recurring, Monthly, $9**. Save, then on the product page
   click **Add another price**: **Recurring, Yearly, $49**.
